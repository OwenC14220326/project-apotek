...
export default function EditPenyakitPage({ params }: { params: { id: string } }) {
    ...
    const fetchPenyakit = async () => {
        try {
            const penyakit = await penyakitAPI.getById(params.id);
            setFormData({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await penyakitAPI.update(params.id, {
                ...formData,
                gejala
            });
            toast({
    ...
    const addGejala = () => {
        const trimmed = newGejala.trim();
        if (trimmed && !gejala.includes(trimmed)) {
            setGejala([...gejala, trimmed]);
            setNewGejala('');
        }
    };
            ...
            <div className="min-h-screen bg-gray-50 p-6">
                <div className="max-w-2xl mx-auto">
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600 mt-2">Perbarui informasi penyakit di bawah ini</p>
                    </div>
